...
public class Email {
	...
	public void setDate(Date date) {
		...
		try {
			this.date = formatter.parse(date.toString());
	...
	public Email(int id,String from, String to, String date, String subject, String body) {
		this.id = id;
		this.path = new ArrayList<Attachement>();
		this.date = new Date();
		SimpleDateFormat formatter = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy", Locale.ENGLISH);
	...
	public String toString() {
		return "Email [id=" + id + ", date=" + date + ", from=" + from + ", to=" + to + ", subject=" + subject
				+ ", body=" + body + ", is_attached=" + is_attached + ", is_archived=" + is_archived + ", path=" + path
				+ "]";
	}
